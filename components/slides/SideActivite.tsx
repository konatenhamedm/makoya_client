...
icon.forEach((el) => {
  ...
  return (
    <div className="flex grid md:grid-rows-3 grid-flow-col gap-4  bg-white shadow-md rounded-lg w-full dark:bg-gray-800 dark:border-gray-700  hover:bg-gray-100">
      ...
      <div className="col-span-2 ...">
        <a href="#">
          <h4 className="text-gray-900 font-semibold text-md tracking-tight dark:text-white justify-center items-center">
      ...
      <div className="row-span-2 col-span-2 ...">
        <div className="flex items-center ">
          <svg
            className="w-3 h-5 text-yellow-300"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        <div className="flex items-center ">
          {/* <span className="text-">599 evaluations</span>  <br /> */}
          <span className="text-xl dark:text-white">Noter ici </span>
          &nbsp;&nbsp;&nbsp;
          <h6>
            <ul
              id="events-example"
    ...
    /*  <div className="max-w-2xl mx-auto">
        <div className="bg-white shadow-md rounded-lg w-full dark:bg-gray-800 dark:border-gray-700 grid grid-cols-3 gap-4">
                 <div className="...">
                 <a href="#">
			<img className="rounded p-2" src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2671&q=80" alt="product image" />
        </a>
                 </div>
                <div className="col-span-2 ...">
