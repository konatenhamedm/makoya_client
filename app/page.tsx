...
import Autocompletes from "../components/headers/autocompletes";
import Categories from "../components/Categories";
import Slides from "../components/slides/slides";
import BigCategorie from "../components/slides/bigCategorie";
import BigBloc from "../components/slides/BigBloc";
import RecenteActivite from "../components/slides/RecenteActivite";
import Carousel from "../components/slides/Caroussel";
...
import ServicePopulaire from "@/components/slides/ServicePopulaire";
...
/* export const metadata: Metadata = {
  title: "Home",
  description: "La page d'accueil Makoya",
}; */
...
export default function Page() {
  return (
    <div className="bg-white my-12">
      ...
      <PubSponsorise />
      <Categories />
      <BigCategorie firstTitle="Mariage" secondTitle="Beauté" />
      <BigCategorie
        firstTitle="Répararation et service"
        secondTitle="Besoins quotidiens"
      />
      <BigBloc
        firstTitle="Répararation et service"
        secondTitle="Besoins quotidiens"
